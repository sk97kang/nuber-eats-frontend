...
export const Restaurant = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="bg-white w-2/6 py-8 pl-40">
      ...
      <div className="container pb-32 flex flex-col items-end mt-20">
        ...
        {orderStarted && (
          <div className="flex items-center">
            <button onClick={triggerConfirmOrder} className="btn px-10 mr-4">
              Confirm Order
            </button>
            <button onClick={triggerCancelOrder} className="btn bg-black px-10">
              Cancel Order
            </button>
          </div>
        )}
